-- Advanced Permission System - Ultimate Version
-- This script works with the actual Permissions table structure
...
BEGIN
    PRINT 'Permissions table exists. Checking structure...'
    ...
    PRINT 'Adding new permissions with proper values...'
