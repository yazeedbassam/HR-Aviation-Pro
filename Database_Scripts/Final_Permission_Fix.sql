-- =====================================================
-- ANSMS Pro - Final Permission System Fix
-- =====================================================
-- This script fixes the permission system based on actual table structure
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@RolesCategoryId, 'Admin', 1)
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@RolesCategoryId2, 'Supervisor', 1)
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@RolesCategoryId3, 'Staff', 1)
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@DivisionsCategoryId, 'AFTN', 1)
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@DivisionsCategoryId2, 'AIS', 1)
...
BEGIN
    ...
    INSERT INTO ConfigurationValues (CategoryId, ValueText, IsActive) 
    VALUES (@DivisionsCategoryId3, 'CNS', 1)
