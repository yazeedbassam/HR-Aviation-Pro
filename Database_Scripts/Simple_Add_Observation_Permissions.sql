-- =====================================================
-- إضافة صلاحيات الملاحظات المنفصلة (مبسط)
-- =====================================================
...
PRINT '========================================'
PRINT 'إضافة صلاحيات الملاحظات المنفصلة (مبسط)'
PRINT '========================================'
...
-- إضافة صلاحيات الملاحظات للمستخدم yazeed.bassam
PRINT '👥 إضافة صلاحيات الملاحظات للمستخدم yazeed.bassam...'
...
SELECT 
    'صلاحيات ملاحظات المراقبين للمستخدم yazeed.bassam' as النوع,
    COUNT(*) as العدد
FROM [UserOperationPermissions] uop
INNER JOIN [users] u ON uop.UserId = u.userid
WHERE u.username = 'yazeed.bassam'
AND uop.EntityType = 'ControllerObservation'

UNION ALL

SELECT 
    'صلاحيات ملاحظات الموظفين للمستخدم yazeed.bassam' as النوع,
    COUNT(*) as العدد
FROM [UserOperationPermissions] uop
INNER JOIN [users] u ON uop.UserId = u.userid
WHERE u.username = 'yazeed.bassam'
AND uop.EntityType = 'EmployeeObservation'
