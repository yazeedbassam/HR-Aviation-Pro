-- Advanced Permission System - Final Version
-- This script works with the existing Permissions table structure
...
PRINT 'New permissions added to existing Permissions table'
