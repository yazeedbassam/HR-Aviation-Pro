-- =====================================================
-- Supabase Fixed Migration Script
-- إصلاح مشكلة View والتحويل الكامل من SQL Server إلى Supabase
-- =====================================================

-- 1. حذف Views الموجودة مسبقاً لتجنب التعارض
-- =====================================================

DROP VIEW IF EXISTS "vw_UserPermissionsSummary" CASCADE;
DROP VIEW IF EXISTS "vw_UserActivityLogs" CASCADE;
...
-- 6. إنشاء Views (بعد إنشاء الجداول)
-- =====================================================
...
INSERT INTO "UserActivityLogs" (
    ...
    1, 'admin', 'System Setup', 'System', 'Supabase fixed migration applied', 
    '127.0.0.1', 'Supabase Fixed Migration Script', CURRENT_TIMESTAMP, true
);
...
BEGIN
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'Supabase Fixed Migration Successful!';
    RAISE NOTICE '=====================================================';
    ...
    RAISE NOTICE 'Views issue fixed!';
