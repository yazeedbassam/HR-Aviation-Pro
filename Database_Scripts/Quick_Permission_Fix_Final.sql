-- Quick Permission System Fix - Final Version
-- This script fixes the CategoryName issue and ensures all permissions work correctly

USE [HR-Aviation]
GO

-- Fix existing Permissions table structure
...
-- Insert operation permissions with proper CategoryName
...
-- Insert menu permissions with proper CategoryName
INSERT INTO Permissions (PermissionKey, PermissionName, PermissionDescription, CategoryName, IsActive, CreatedAt)
SELECT 
...
PRINT 'Permission system fix completed successfully!'
PRINT 'All required tables, permissions, and stored procedures have been created/fixed.'
PRINT 'The CategoryName issue has been resolved.'